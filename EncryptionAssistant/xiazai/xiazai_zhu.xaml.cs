...
namespace EncryptionAssistant.xiazai
{
    ...
    /// </summary>
    public sealed partial class xiazai_zhu : Page
    {
        public xiazai_zhu()
        {
        ...
        {
            App.Huancun.xiazai.Xianshitishi += Md5_Xianshitishi;
            //匹配页面
            this.zhengzai.Navigate(typeof(zhengzai_xiazai));
            this.wangcehng.Navigate(typeof(wangcheng));
        }
