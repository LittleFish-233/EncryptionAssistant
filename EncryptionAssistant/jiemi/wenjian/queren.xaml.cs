...
namespace EncryptionAssistant.jiemi.wenjian
{
    ...
    public sealed partial class queren : Page
    {
        ...
        private void Queren_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //记录
            App.Huancun.jiemi_wenjian.yeshu = 4;
        }
        ...
        private async void tianjiawenjian_ClickAsync(object sender, RoutedEventArgs e)
        {
            ...
            {
                var resourceLoader = Windows.ApplicationModel.Resources.ResourceLoader.GetForCurrentView("jie_queren");
                //"选择文件时发生错误<" 
        ...
        private void xiayibu_Click(object sender, RoutedEventArgs e)
        {
            ...
            //解密
            App.Huancun.jiemi_wenjian.jiemi_jingdu.JiemiwemjianAsync(App.Huancun.jiemi_wenjian.wenjian_liebiao, App.Huancun.jiemi_wenjian.baocun_dizhi,  App.Huancun.jiemi_wenjian.shanchuyuanwenjian, App.Huancun.jiemi_wenjian.mishi, App.Huancun.jiemi_wenjian.suanfa, App.Huancun.jiemi_wenjian.mima_linshi, 0);
            //翻页
            this.Frame.Navigate(typeof(zhengzaijiemi));
        }
