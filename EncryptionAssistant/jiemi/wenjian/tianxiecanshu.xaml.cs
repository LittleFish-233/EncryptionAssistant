...
namespace EncryptionAssistant.jiemi.wenjian
{
    ...
    public sealed partial class tianxiecanshu : Page
    {
        ...
        private void Tianxiecanshu_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //记录
            App.Huancun.jiemi_wenjian.yeshu = 2;

            //密码状态
            mima_shu.Mima_zhuangtai = App.Huancun.jiemi_wenjian.mima_zhuangtai;
            //算法
            chuli_mishi.Suanfa = App.Huancun.jiemi_wenjian.suanfa;
            chuli_suan.Suanfa_huoqu = App.Huancun.jiemi_wenjian.suanfa;

            //密匙
            chuli_mishi.mishi_huoqu = App.Huancun.jiemi_wenjian.mishi;
            
            //位数
            chuli_mishi.Weishu_huoqu = App.Huancun.jiemi_wenjian.mishi_weishu;
            //密码
            mima_shu.Mima = App.Huancun.jiemi_wenjian.mima_shuru;
            //默认密匙
            chuli_mishi.shifou = App.Huancun.jiemi_wenjian.shifou_mishi;

            //高级
            if (App.Huancun.jiemi_wenjian.xianshigaoji==true)
            {
            ...
            //选项
            sanchu.IsChecked = App.Huancun.jiemi_wenjian.shanchuyuanwenjian;
        ...
        {
            App.Huancun.jiemi_wenjian.mima_zhuangtai = mima_shu.Mima_zhuangtai;
            if(App.Huancun.jiemi_wenjian.mima_zhuangtai==2)
            {
                App.Huancun.jiemi_wenjian.mima_linshi = mima_shu.Mima;
            }
            else
            {
        ...
        private void Mima_shu_Cuowu(string a, int xuhao)
        {
            switch(xuhao)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    var resourceLoader = Windows.ApplicationModel.Resources.ResourceLoader.GetForCurrentView("jie_tianxiecanshu");
        ...
        private void gaoji_Click(object sender, RoutedEventArgs e)
        {
            if(textblock14.Visibility==Visibility.Collapsed)
            {
                ...
                textblock14.Visibility = Visibility.Visible;
                textblock18.Visibility = Visibility.Collapsed;
                App.Huancun.jiemi_wenjian.xianshigaoji = true;
            }
            else
            {
                ...
                textblock18.Visibility = Visibility.Visible;
                textblock14.Visibility = Visibility.Collapsed;
                App.Huancun.jiemi_wenjian.xianshigaoji = false ;
            }
        }
        ...
        private void xiayibu_Click(object sender, RoutedEventArgs e)
        {
            ...
            //检查密码
            if (App.Huancun.jiemi_wenjian.mima_zhuangtai == 2 || (App.Huancun.jiemi_wenjian.mima_zhuangtai == 0 && App.Huancun.jiemi_wenjian.mima_shuru == ""&&App.Huancun.jiemi_wenjian.mima_linshi==""))
            {
                
            }
            else
            {
                if (App.Huancun.jiemi_wenjian.mima_zhuangtai == 0)
                {
                    //"请单击 < 使用 > 按钮以确认密码无误"
            ...
            if (App.Huancun.jiemi_wenjian.shifou_mishi == true)
            {
