...
namespace EncryptionAssistant.jiemi.wenjian
{
    ...
    public sealed partial class tianjiamubiao : Page
    {
        ...
        private void Tianjiamubiao_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //记录
            App.Huancun.jiemi_wenjian.yeshu = 0;
        }
        ...
        private async void tianjia_wenjian_ClickAsync(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    {
                        App.Huancun.jiemi_wenjian.wenjian_liebiao.tianjiawenjian(file);
                    }
            ...
            {
                var resourceLoader = Windows.ApplicationModel.Resources.ResourceLoader.GetForCurrentView("jie_tianjiamubiao");
                //"选择文件时发生错误<" 
        ...
        private async void Button_ClickAsync(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (folder != null)
                {
                    ...
                    msgPopup.ShowWIndow();
                    //添加我
                    await App.Huancun.jiemi_wenjian.wenjian_liebiao.TianjiawenjianjiaAsync(folder);
                    //关闭
        ...
        private async void VcBorder_DropAsync(object sender, DragEventArgs e)
        {
            ...
            if (e.DataView.Contains(StandardDataFormats.StorageItems))
            {
                ...
                {
                    App.Huancun.jiemi_wenjian.wenjian_liebiao.tianjiawenjian(linshi_1);
                }
                //文件夹
                ...
                foreach (StorageFolder linshi_2 in items_2)
                {
                    ...
                    msgPopup.ShowWIndow();
                    //添加我
                    await App.Huancun.jiemi_wenjian.wenjian_liebiao.TianjiawenjianjiaAsync(linshi_2);
                    //关闭
                    msgPopup.DismissWindow();
                }
                Frame.Navigate(typeof(jixutianjia));
