...
namespace EncryptionAssistant.jiemi
{
    /// <summary>
    /// 可用于自身或导航至 Frame 内部的空白页。
    /// </summary>
    public sealed partial class jie_zhuye : Page
    {
        ...
        public jie_zhuye()
        {
            ...
            Loaded += Jie_zhuye_Loaded;
        }

        private void Jie_zhuye_Loaded(object sender, RoutedEventArgs e)
        {
            wenben.Navigate(typeof(wenben.jiemiwenben));
            switch (App.Huancun.jiemi_wenjian.yeshu)
            {
                case 0:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    wenjian.Navigate(typeof(wenjian.zhengzaijiemi));
                    break;
                case 6:
            ...
            try
            {
                App.Huancun.jiemi.Xianshitishi -= Jiemi_Xianshitishi;
            }
            catch
            {
        ...
        private void Jiemi_Xianshitishi(string a, int xuhao)
        {
            // 显示提示
            textblock2.Text = a;
