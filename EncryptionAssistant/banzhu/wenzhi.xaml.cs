...
namespace EncryptionAssistant.banzhu
{
    ...
    /// </summary>
    public sealed partial class wenzhi : Page
    {
        ...
        public wenzhi()
        {
            ...
            Loaded += Wenzhi_Loaded;
            
        }

        private void Wenzhi_Loaded(object sender, RoutedEventArgs e)
        {
            App.Huancun.cundan.Xianshitishi += Banzhu_Xianshitishi;
            //匹配页面
            jiubanben.Navigate(typeof(cundang));
            shiyong.Navigate(typeof(shiyong));
            guanyu.Navigate(typeof(guanyu));
        }

        private void Banzhu_Xianshitishi(string a, int xuhao)
        {
            // 显示提示
            textblock2.Text = a;
